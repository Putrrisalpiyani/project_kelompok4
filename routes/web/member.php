...
use App\Http\Controllers\Member\mahasiswaController;
...
//
Route::get('/pelanggan',[EmployeeController::class, 'index'])->name('pelanggan');

Route::get('/tambahpelanggan',[EmployeeController::class, 'tambahpelanggan'])->name('tambahpelanggan,index');
